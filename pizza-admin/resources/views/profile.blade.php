        ...
        <div class="col-lg-4 order-lg-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4">
                    <img src="https://image.freepik.com/free-vector/pizza-icon-fast-food-collection-food-icon-isolated_138676-504.jpg" class="rounded-circle" alt="user-image">
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-8 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($user, [ 'url' => route('profile.update',$user)]) !!}
                    @method('PATCH')
